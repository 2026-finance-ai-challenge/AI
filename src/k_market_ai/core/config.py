...
class Settings(BaseSettings):
    ...
    news_narrative_prompt_version: str = "news-narrative-v13"
    ...
    agent_prompt_version: str = "market-agent-v8"
    agent_timeout_seconds: float = Field(default=90.0, ge=10.0, le=90.0)
    ...
    def title_translation_prompt_version(self) -> str:
        ...
        return "financial-title-translation-v13"
